  ...
  routes: [
    ...
    // Customer Routes
    {
      ...
      children: [
        ...
        { path: 'product', name: 'ProductDetail', component: () => import('@/views/customer/ProductDetailPage.vue') },
        ...
        { path: 'orders', name: 'OrderHistory', component: () => import('@/views/customer/OrderHistoryPage.vue') },
        { path: 'wishlist', name: 'WishList', component: () => import('@/views/customer/WishListPage.vue') },
        { path: 'account', name: 'AccountDashboard', component: () => import('@/views/customer/AccountDashboardPage.vue') },
        { path: 'about-us', name: 'AboutUs', component: () => import('@/views/customer/AboutUsPage.vue') },
        { path: 'contact-us', name: 'ContactUs', component: () => import('@/views/customer/ContactUsPage.vue') },
      ]
    },
