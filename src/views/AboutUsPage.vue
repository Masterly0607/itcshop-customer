  ...
  <section class="container-default">
    ...
    <div class="mt-20">
      <div class="flex gap-3">
        <div class="flex flex-col gap-3 items-center justify-center border-1 p-5 w-1/4">
          <div class="badge badge-neutral w-10 h-10 rounded-full badge-xs">
            <svg
          ...
          <div class="font-bold text-2xl">10.5k</div>
          <div class="text-sm">Sellers active our site</div>
        </div>
        <div class="flex flex-col gap-3 items-center justify-center border-1 p-5 w-1/4 bg-primary">
          <div class="badge badge-neutral w-10 h-10 rounded-full badge-xs">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <div class="font-bold text-2xl">33k</div>
          <div class="text-sm">Monthly Product Sale</div>
        </div>
        <div class="flex flex-col gap-3 items-center justify-center border-1 p-5 w-1/4">
          <div class="badge badge-neutral w-10 h-10 rounded-full badge-xs">
            <svg
          ...
          <div class="font-bold text-2xl">45.5k</div>
        ...
        <div class="flex flex-col gap-3 items-center justify-center border-1 p-5 w-1/4">
          ...
          <div class="font-bold text-2xl">25k</div>
    ...
    <!-- Last -->
    <div class="grid sm:grid-cols-3 gap-8 text-center py-8 px-4 mt-30">
      <div v-for="(item, index) in features" :key="index" class="flex flex-col items-center gap-2">
